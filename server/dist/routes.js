...
const prisma_feedbacks_repositoy_1 = require("./repositories/prisma/prisma-feedbacks-repositoy");
...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const prismaFeedbacksRepository = new prisma_feedbacks_repositoy_1.PrismaFeedbacksRepository();
    ...
    // await serve para esperar a função ser concluída para continuar a execução do programa
